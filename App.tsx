    ...
    <div className="h-screen flex flex-col md:flex-row app-shell overflow-hidden relative">
      ...
      <main className="flex-grow flex flex-col relative overflow-hidden h-full">
        ...
        <div className={`fixed md:absolute left-0 right-0 px-3 sm:px-4 md:px-6 lg:px-12 z-50 transition-all duration-700 ease-[cubic-bezier(0.16, 1, 0.3, 1)] ${isMinimized ? 'bottom-0 translate-y-2 sm:translate-y-3' : 'bottom-3 sm:bottom-4 md:bottom-6 lg:bottom-10'}`}>
          <div className={`max-w-5xl mx-auto glass-panel compose-panel rounded-2xl sm:rounded-3xl border-white/10 shadow-[0_60px_150px_-30px_rgba(0,0,0,1)] relative overflow-hidden flex flex-col ${isLightTheme ? 'max-h-[40vh] sm:max-h-[38vh]' : 'max-h-[50vh] sm:max-h-[45vh]'} ${isMinimized ? 'p-3 sm:p-4 rounded-b-none border-b-0' : isLightTheme ? 'p-3 sm:p-4 md:p-4' : 'p-4 sm:p-5 md:p-6'}`}>
